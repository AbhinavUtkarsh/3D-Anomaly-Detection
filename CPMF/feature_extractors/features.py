...
class Features(torch.nn.Module):
    def __init__(self, image_size=224, f_coreset=0.1, coreset_eps=0.9, backbone_name='nasnetalarge'):
        super().__init__()
...
class ModelINet(torch.nn.Module):
    def __init__(self, device, backbone_name='nasnetalarge', out_indices=(1, 2, 3), checkpoint_path='',
                 pool_last=False):
        super().__init__()
